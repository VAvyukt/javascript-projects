let person, walkingSheet, idleSheet, runningSheet;
let ground;
...
function preload() {
    ...
    runningSheet = loadImage('https://codehs.com/uploads/59c0e710552d6f1add98413b5720bc53');
    ...
    person.addAni('running', runningSheet, {w: 48, h: 30, row: 0, frames: 8, frameDelay: 8});
